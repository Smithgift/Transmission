...
Chapter 2: We learn more about the world. Stella tells James that she'll be Transmitted, too, but she learned something about the Destination. There are eight worlds to climb, but death sends you back to a random place on the first one. There's also some strange system there, one that makes no sense. Also, the Perfects know something about the Destination that Stella can't put into words. 
...
Chapter 29: Lucky explains the strange magic system of the Tower of Worlds: to cast a spell requires the chants found on the scrolls, magical capacity given by the "Magic" (Crane) stat, and magical color. This color shines from the stars at certain intervals, and can be also radiated by some items and monsters, as well as temporarily by burning a scroll. Their discussion is interrupted by coming across an allegedly friendly patrol.
